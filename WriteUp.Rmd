...
We now check if any pairs of variables has a correlation of 0.8 or higher.
If yes, then principal component analysis is performed and only those
...
Having obtained an overall accuracy of 97%, and taking
into accounttime/computational limitations, I believe
